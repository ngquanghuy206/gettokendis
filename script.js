...
showToast('⚠️ Cấu hình client_id hoặc redirect_uri chưa đúng!','error');
return;
}
...
popup=window.open(authUrl,'DiscordLogin',
'width='+width+',height='+height+',left='+left+',top='+top+
',menubar=no,toolbar=no,location=no,status=no');
if(!popup){
showToast('⚠️ Popup bị chặn, hãy cho phép popup!','error');
return;
}
loginBtn.disabled=true;
loginBtn.innerHTML='⏳ Đang đăng nhập...';
statusMsg.textContent='⏳ Đang chờ login...';
